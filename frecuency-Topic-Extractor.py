...
def vocabulario(tokens):
    ...
    for x in tokens:
        if ((x is int) or (len(x)<4 )):            
           ...
           # print(palabra)
            ...
            tokens[index]  = lem.lemmatize(palabra3)
                # if x in palabrasvac:
                #     tokens[index].remove()
                # else:
                #     continue
   ...
   # print(tokens)
    ...
    #print(type(words))
    words,frecuenciaPalab=wordCount(vocab_need)     
...
def miner(subjects,subjects_f):
    ...
    return topicsAll,frecuencyAll,topicsSubjects,frecuencySubjects
...
if __name__ == "__main__":
    ...
    topicsAll,frecuencyAll,topicsSubjects,frecuencySubjects=miner(subjects,subjects_f)
  

    listWordFrecuencyAll=list(zip(topicsAll,frecuencyAll))
    #print("*****************************listWordFrecuencyAll *******************************")
    #print(list(listWordFrecuencyAll))

    sorterListTopics=termFrecuency(topicsSubjects,frecuencySubjects,topicsAll,frecuencyAll)

   # print("*****************************WordAll *******************************")
    #print(list(sorterListTopics))
    writeTopics(sorterListTopics,subjects)